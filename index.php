        ...
        <div class="container my-10 px-8 mx-auto lg:pt-10 lg:pb-20">
            ...
            <div class="grid lg:grid-cols-3 lg:gap-5 gap-14 ">
                <div class="text-center p-4">
                    ...
                    <p class="px-8 text-justify">From concept to reality, we build modern and functional websites that represent your brand and attract your target audience.</p>
                </div>

                <div class="text-center p-4">
                    <div><img src="img/web-design (1).png" alt="" class="w-14 h-14 mx-auto"></div>
                    <h3 class="py-2 text-xl font-semibold">Website Designing</h3>
                    <p class="px-8 text-justify">Our creative team crafts visually stunning websites, focusing on user experience and aesthetics to leave a lasting impression on your visitors. </p>
                </div>

                <div class="text-center p-4">
                    <div><img src="img/data.png" alt="" class="w-14 h-14 mx-auto"></div>
                    <h3 class="py-2 text-xl font-semibold">Website Re-Designing</h3>
                    <p class="px-8 text-justify">Revamp your outdated website and stay ahead of the competition. Our redesign services breathe new life into your online presence, enhancing functionality and visual appeal. </p>
                </div>

                <div class="text-center p-4">
                    <div><img src="img/web-design.png" alt="" class="w-14 h-14 mx-auto"></div>
                    <h3 class="py-2 text-xl font-semibold">Website Maintenance</h3>
                    <p class="px-8 text-justify">Leave the technical aspects to us. Our website maintenance services ensure that your site remains secure, up-to-date, and optimized for peak performance, while you focus on your business.</p>
                </div>
                ...
                <div class="text-center p-4">
                    ...
                    <p class="px-8 text-justify">Today's users expect a sleek and user-friendly website design that reflects your brand's unique style. Don't be afraid to take risks and get creative with your design choices!</p>
                </div>

                <div class="text-center p-4">
                    <div><img src="img/code.png" alt="" class="w-14 h-14 mx-auto"></div>
                    <h3 class="py-2 text-xl font-semibold">Coding And Technology</h3>
                    <p class="px-8 text-justify">With our coding and technology services, you can focus on what you do best while we handle the rest. From coding to project management, we've got you covered every step of the way.</p>
                </div>
            </div>
        </div>
        </div>
    ...
    <div class="lg:w-3/4 mx-auto">
        <div class="container mx-auto my-10 px-8">
            <div class="text-center py-10">
                ...
                <p class="text-lg text-center py-4 lg:px-4 ">Belgium Webnet is a confidant to many global brands. In the last two years, we have served 150+ premium brands. Be it for a small, medium, or large-scale business, we have done it all.</p>
            </div>
           ...
           <div class="text-center"><button class="border-2 border-black text-lg px-4 py-1">View More</button></div>
        </div>
    </div> 
 <!-- ......marques........... -->
    <div>
...
<!-- <div class="bg-gray-50 py-10">
    ...
    <div class="container my-10 px-8 mx-auto">
        ...
        <div class="grid lg:grid-cols-2 gap-5 place-content-center justify-items-center lg:h-[300px]">
            <div class="grid lg:grid-cols-3 gap-5 items-center">
                ...
                <div class="text-center border border-blue-600 rounded-lg w-40 h-40 grid place-content-center">
                    <span class="text-center text-4xl text-blue-600"><i class="fa-solid fa-calendar-days"></i></span>
            ...
            <div class="grid place-content-center">
                <p class="text-justify">Want to sell your Jewelry online? Over, 50% of your customers are looking for you on the internet. We are here to help you bridge this gap. Our Web Design and Development experts curate amazing websites for your jewelry business. Ultimately, show up your unbeatable online presence. Now, become accessible to your vast spectrum of online buyers. Attract them with your Trendy Jewelry Website. Hire our expert web developers today!</p>
            </div>
        </div>
        <div>
            <h3 class="text-4xl font-extrabold lg:mt-4 text-blue-600 my-5">Step Up Your Jewelry Game With Our Top and Trendy Jewelry Web Designs</h3>
    ...
    <h1 class="slidupeanimate text-4xl font-extrabold mt-4 text-blue-600 ">Create Your Own Wonderland With Our Magnitude Of Themes!</h1>
    </div>
    <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-10 ">
        <div class="slidupeanimate card hover:drop-shadow-xl border overflow-hidden">
            ...
            <div class="absolute top-0 cursor-pointer  left-4 bg-red-600 text-white px-6 py-2 hover:bg-blue-400 text-sm"><a href="https://hg.oriflammeinfotech.com/home" target="_blank"><h4>Live Preview</h4></a></div>
        </div>
            <div class="p-4 bg-white">
                <!-- <span class="my-2 text-red-600">April 17, 2023</span> -->
                <h1 class="my-2 text-2xl font-semibold text-blue-600 hover:text-red-600 cursor-pointer"><a href="https://hg.oriflammeinfotech.com/home" target="_blank">HG Jewel website demo</a></h1>
        ...
        <div class="slidupeanimate card hover:drop-shadow-xl border overflow-hidden">
            ...
            <div class="absolute top-0 cursor-pointer  left-4 bg-red-600 text-white px-6 py-2 hover:bg-blue-400 text-sm"><h4>Live Preview</h4></div>
        </div>
            <div class="p-4 bg-white">
                <!-- <span class="my-2 text-red-600">April 17, 2023</span> -->
                <h1 class="my-2 text-2xl font-semibold text-blue-600 hover:text-red-600 cursor-pointer">Top JF Jewel Website</h1>
               <div class="border-t border-gray-400">
                <!-- <button class="border border-red-700 hover:border-sky-800 mt-2 bg-red-600 hover:bg-blue-400 text-white hover:text-red-600 text-sm font-semibold px-4 py-2 rounded-md my-2">Read More</button> -->
                </div>
        </div>
        ...
        <div class="slidupeanimate  card hover:drop-shadow-xl border overflow-hidden">
            ...
            <div class="absolute cursor-pointer top-0 left-4 bg-red-600 text-white px-6 py-2 hover:bg-blue-400 text-sm"><h4>Live Preview</h4></div>
        </div>
            <div class="p-4 bg-white">
                <!-- <span class="my-2 text-red-600">April 17, 2023</span> -->
                <h1 class="my-2 text-2xl font-semibold text-blue-600 hover:text-red-600 cursor-pointer">TanJewel Website</h1>
               <div class="border-t border-gray-400">
                <!-- <button class="border border-red-700 hover:border-sky-800 mt-2 bg-red-600 hover:bg-blue-400 text-white hover:text-red-600 text-sm font-semibold px-4 py-2 rounded-md my-2">Read More</button> -->
                </div>
        </div>
