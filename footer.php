...
<div class="bg-[rgb(16,32,54)] border-b-2 lg:py-0 py-5 border-white">
    <div class="container mx-auto  px-8 grid lg:grid-cols-3 lg:py-4 place-content-center w-full">
        <div class="flex items-center text-blue-400">
            ...
            <div>
                ...
                <p  class="text-xl font-bold"><a href="tel:+91-9930425384 ">  +91-9930425384</a><span>/</span><a href="tel:9930646412"> 9930646412</a></p>
            </div>
        </div>
    
    <div><img src="img/logo-png.png" alt=""></div>
    
        <div class="flex items-center lg:justify-end text-blue-400">
            <div>
                <h1 class="font-semibold">Mail Us</h1>
                <p  class="text-xl  font-bold"><a href="mailto: pravin@oriflammeitsolutions.com"> pravin@jewelwebnet.com</a></p>
            </div>
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10">
...
<div class="bg-[rgb(16,32,54)]">
    <footer class=" ">
        ...
        <div class="cursor-pointer">
            ...
            <p  class="text-lg  my-5 text-white"><span>Email :</span><a href="mailto: pravin@oriflammeitsolutions.com"> pravin@jewelwebnet.com</a></p>
        ...
        <div class="cursor-pointer">
            ...
            <form>   
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search" class="block w-80 mx-auto p-2 pl-5 text-lg  text-gray-700 border border-gray-300  bg-gray-50  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Subscribe with us" required>
    ...
    <div>
        ...
        <p class="text-lg text-white">© 2023 <span class="text-blue-400">Jewel Webnet</span> Powered by <span class="text-red-600">Jewel Webnet</span></p>
        <div class="text-right bg-red-200">
        <button id="scroll" class="border border-sky-600 p-4 bg-sky-800 fixed bottom-4 right-4 text-4xl text-red-700 rotate-90">&#10096;</button>
        </div>
    </div>
    </div>
    </footer>
...
<div class="cookie-container">
    ...
    <script>
        ...
        const executCodes = () =>{
            if (document.cookie.includes("coding lab"))
            cookieBox.classList.add("show");

            buttons.foreach((button)=>{
                button.addEvenList("click", ()=>{
                    cookieBox.classList.remove("show");

                    // if button has acceptBtn Id
                    if(button.id == "acceptBtn"){
                        // set cookie for 1month.60 =1min.60=1hours, 24=1day,30=30 days.
